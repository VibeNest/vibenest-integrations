...
-- A buyer may own the same grant through independent one-time and subscription sources.
-- Revoking one source never destroys another active contribution.
...
-- scope_digest = SHA-256(environment id + manifest digest + exact SOURCE_COMMIT).
